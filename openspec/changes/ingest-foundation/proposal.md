...
- **新增依賴**:`apscheduler`、`aiolimiter`、`tenacity`、`structlog`、`finmind`、`pydantic`、`pydantic-settings`、`sqlalchemy[asyncio]`、`asyncpg`、`alembic`、`httpx`、`fastapi`、`uvicorn`(全 permissive license,見 `make-vs-buy.md`)
